...
const steps = [
  ...
  { id: 3, name: "Review & Confirm", description: "Review before registration" },
  { id: 4, name: "Registration", description: "Blockchain registration" },
]
          ...
          <div className="space-y-6">
            ...
            <div className="bg-muted/50 p-4 rounded-lg">
              ...
              <div className="flex flex-wrap gap-2">
                {["PDF", "DOC", "DOCX", "TXT", "JPG", "PNG", "SVG", "MP4", "MP3", "ZIP"].map((type) => (
      ...
      case 3:
        return (
          <div className="space-y-6">
            ...
            <IPPreview data={watchedData} files={uploadedFiles} />
          ...
          <div className="text-center space-y-6">
            ...
            <div>
              <h3 className="font-heading font-semibold text-xl mb-2">
                {isSubmitting ? "Registering on Blockchain..." : "Ready to Register"}
              </h3>
              <p className="text-muted-foreground">
                {isSubmitting
                  ? "Please wait while we register your IP on the blockchain. This may take a few moments."
                  : "Your IP registration is ready to be submitted to the blockchain."}
              </p>
            </div>
